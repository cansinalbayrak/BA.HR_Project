...
namespace BA.HR_Project.Persistance.Migrations
{
    ...
    [Migration("20231220140849_MigInit")]
            ...
            modelBuilder.Entity("BA.HR_Project.Domain.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ae05658c-ba71-4905-a0f2-78b1e6bf9962",
                            ConcurrencyStamp = "ab7a2143-d092-46e6-bc71-9dacbdb33d55",
                            Name = "Admin",
            ...
            modelBuilder.Entity("BA.HR_Project.Domain.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "db7dfc41-56b4-416e-97a1-eed3713618cd",
                            AccessFailedCount = 3,
                            AdressId = "SeedAdress1",
                            BirthDate = new DateTime(2023, 12, 20, 17, 8, 49, 76, DateTimeKind.Local).AddTicks(4208),
                            CompanyId = "SeedCompany1",
                            ConcurrencyStamp = "89d214d8-ed5c-44ac-9092-ef284b05f60c",
